...
namespace ExternalUserService.Tests.Services
{
    public class ExternalUserServiceTests
    {
        ...
        {
            // Arrange
            var usersDto = new List<ApiResponse>
            {
                new ApiResponse { Id = 1, Email = "user1@example.com", First_Name = "User1", Last_Name = "Test1" },
                new ApiResponse { Id = 2, Email = "user2@example.com", First_Name = "User2", Last_Name = "Test2" }
            };
